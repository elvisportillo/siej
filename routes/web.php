...
Route::get("mostrar-informes-de-gestion", [InformesGestionController::class, 'listarInformesGestion'])->name("mostrar-informes-de-gestion");
Route::post("buscar-informes", [InformesGestionController::class, 'buscarInformes'])->name("buscar-informes");
...
Route::post("/g", [InformesGestionController::class, 'guardar']);
...
Route::group(['middleware' => ['auth']], function(){
    Route::get("/cargar/{tribunal}/{funcionario}/{mes_evaluado}", [InformesGestionController::class, 'cargarFormularioPorEspecialidad']);
